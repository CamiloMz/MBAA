...
class TestView:
    ...
    budget_amount_label = Label(budget_tree_frame, text="Amount:")
    budget_amount_entry = Entry(budget_tree_frame)
    ...
    def budget_list_view(self, budget_list):
        ...
        self.budget_tree.column("Amount", anchor="center", width=100)
        ...
        self.budget_tree.heading("Amount", text="Amount", anchor="center")
        ...
        for budget in budget_list:
            ...
            self.budget_tree.insert(
                "",
                "end",
                values=(budget[1], float(budget[2]), budget[3]),
            )
    ...
    def create_budget_view(self):
        ...
        self.budget_amount_label.place(
            x=10,
            y=230,
            width=self.BUDGET_LABEL_WIDTH,
        )
        self.budget_amount_entry.place(x=130, y=230, width=self.BUDGET_INPUT_WIDTH)
